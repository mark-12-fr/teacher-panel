...
// Class Performance section-picker (ported from performance.html). Same section
          ...
          filtered.map((sec) => (
            <div className="section-card" key={sec.id}>
              ...
              <div className="card-actions">
                ...
                <button className="view-btn" onClick={() => (window.location.href = `/performance/${sec.id}`)}>View</button>
              </div>
            </div>
          ))
        )}
